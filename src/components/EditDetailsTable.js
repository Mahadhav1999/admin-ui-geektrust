...
import { GET_DATA_URL } from '../DataUrl';
const { Search } = Input;
...
const EditTable = () => {
          ...
          <>
            {editable ? (
              ...
              <Typography.Link
                ...
                onClick={() => edit(record)}
              >
                <Tooltip placement='left' title='Edit Record'>
            ...
            <div className="delete-btn">
              ...
              >
                <Tooltip placement="bottom" title='Delete Record'>
                  <DeleteFilled style={{ color: '#ff4d4f',marginLeft:'20px',fontSize:'15px' }} />
                </Tooltip>
              </Typography.Link>
            </div>
          </>
  ...
  return (
    <>
      <Search
        placeholder='Search by any name, email and role  . . . .'
